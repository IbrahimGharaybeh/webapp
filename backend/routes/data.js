...
export default function(pool) {
  ...
  // =============================================
  // 1. PERSON PERMITS (permit_type = 1)
  // =============================================
  ...
  // =============================================
  // 2. VEHICLE PERMITS (permit_type = 2)
  // =============================================
    ...
    try {
      ...
      const insertResult = await client.query(
        ...
        [
          ...
          req.body.nationality, req.body.religionDen, req.body.passportNo,
          req.body.fullResidenceNo, req.body.occupation, req.body.emiratesIdNo,
          req.body.mobileNo, req.body.dob, req.body.expiryDate1, req.body.expiryDate2,
          req.body.email, req.body.instagram, req.body.twitter, req.body.facebook,
          req.body.others, req.body.remarks, JSON.stringify(req.body.permittedLocations || [])
        ]
      );
      ...
      await client.query(
        `INSERT INTO permit_representative_index (permit_type, rep, company_id, permit_id, is_draft)
         VALUES ($1, $2, $3, $4, $5)`,
        [2, testUserId, req.body.companyId, permit.id, req.body.isDraft]
      );
  ...
  // =============================================
  // 4. PHOTOGRAPHY PERMITS (permit_type = 4)
  // =============================================
